 ...
 */
static char *font = { "Hack:size=10:antialias=true:autohint=true", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true", "Liberation Mono:pixelsize=10:antialias=true:autohint=true" };
...
#include "/home/DrRoot/.cache/wal/colors-wal-st.h"
